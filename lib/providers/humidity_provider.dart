...
class HumidityProvider extends ChangeNotifier {
  final Map<String, HumidityData> plantToHumidityData = Map<String, HumidityData>();
  final HumiditySensorsService sensorsService = LocalHumiditySensorsService(http.Client());
